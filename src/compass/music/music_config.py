...
class ErrorMessages:
    ...
    def WRONG_USER_VC(vc):
        msg = f":exclamation: User is not in <#{vc.id}>. Please use the `/join` command, "
        msg += "or move/disconnect Compass and try again."
        return msg
...
#     SONGINFO_ERROR = """
# :exclamation: Unsupported site or age restricted content. # To enable age restricted content check the docs/wiki.
# """
#     SONGINFO_SECONDS = "s"
