...
from compass_bot.music.music_utils import Origins
from compass_bot.music.player import Timer
from compass_bot.utils.bot_config import EMBED_COLORS
...
class Music(commands.Cog):
    ...
    async def get_player(self, ctx):
        ...
        current_guild = music_utils.get_guild(bot, ctx.message)
